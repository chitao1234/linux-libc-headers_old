	...
	if (sizeof(type) != sizeof(u64) || sizeof(u64) == sizeof(long))	\
		*__mem = __val;						\
		...
		BUG();							\
									...
									\
static inline type pfx##read##bwlq(volatile void *mem)		\
{									\
	volatile type *__mem;						\
	type __val;							\
									\
...
#define __BUILD_MEMORY_STRING(bwlq, type)				\
									\
static inline void writes##bwlq(volatile void *mem, void *addr,	\
				unsigned int count)			\
{									\
	...
	while (count--) {						\
		...
		__addr++;						\
									...
									\
static inline void reads##bwlq(volatile void *mem, void *addr,	\
			       unsigned int count)			\
{									\
	volatile type *__addr = addr;					\
									\
