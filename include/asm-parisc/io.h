...
extern void __raw_bad_addr(const volatile void *addr);
...
static inline unsigned long long __raw_readq(const volatile void *addr)
{
	return *(volatile unsigned long long *) addr;
}

static inline void __raw_writeb(unsigned char b, volatile void *addr)
{
	*(volatile unsigned char *) addr = b;
}
static inline void __raw_writew(unsigned short b, volatile void *addr)
{
...
static inline void __raw_writeq(unsigned long long b, volatile void *addr)
{
...
void memset_io(volatile void *addr, unsigned char val, int count);
void memcpy_fromio(void *dst, const volatile void *src, int count);
void memcpy_toio(volatile void *dst, const void *src, int count);

/* Support old drivers which don't ioremap.
 * NB this interface is scheduled to disappear in 2.5
 */

#define __isa_addr(x) (void *)(F_EXTEND(0xfc000000) | (x))
