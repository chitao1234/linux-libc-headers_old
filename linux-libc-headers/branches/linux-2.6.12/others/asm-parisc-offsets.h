...
#define TASK_SIGPENDING 1340 /* offsetof(struct task_struct, pending) */
...
#define TASK_REGS 816 /* offsetof(struct task_struct, thread.regs) */
#define TASK_PT_PSW 816 /* offsetof(struct task_struct, thread.regs.gr[ 0]) */
#define TASK_PT_GR1 820 /* offsetof(struct task_struct, thread.regs.gr[ 1]) */
#define TASK_PT_GR2 824 /* offsetof(struct task_struct, thread.regs.gr[ 2]) */
#define TASK_PT_GR3 828 /* offsetof(struct task_struct, thread.regs.gr[ 3]) */
#define TASK_PT_GR4 832 /* offsetof(struct task_struct, thread.regs.gr[ 4]) */
#define TASK_PT_GR5 836 /* offsetof(struct task_struct, thread.regs.gr[ 5]) */
#define TASK_PT_GR6 840 /* offsetof(struct task_struct, thread.regs.gr[ 6]) */
#define TASK_PT_GR7 844 /* offsetof(struct task_struct, thread.regs.gr[ 7]) */
#define TASK_PT_GR8 848 /* offsetof(struct task_struct, thread.regs.gr[ 8]) */
#define TASK_PT_GR9 852 /* offsetof(struct task_struct, thread.regs.gr[ 9]) */
#define TASK_PT_GR10 856 /* offsetof(struct task_struct, thread.regs.gr[10]) */
#define TASK_PT_GR11 860 /* offsetof(struct task_struct, thread.regs.gr[11]) */
#define TASK_PT_GR12 864 /* offsetof(struct task_struct, thread.regs.gr[12]) */
#define TASK_PT_GR13 868 /* offsetof(struct task_struct, thread.regs.gr[13]) */
#define TASK_PT_GR14 872 /* offsetof(struct task_struct, thread.regs.gr[14]) */
#define TASK_PT_GR15 876 /* offsetof(struct task_struct, thread.regs.gr[15]) */
#define TASK_PT_GR16 880 /* offsetof(struct task_struct, thread.regs.gr[16]) */
#define TASK_PT_GR17 884 /* offsetof(struct task_struct, thread.regs.gr[17]) */
#define TASK_PT_GR18 888 /* offsetof(struct task_struct, thread.regs.gr[18]) */
#define TASK_PT_GR19 892 /* offsetof(struct task_struct, thread.regs.gr[19]) */
#define TASK_PT_GR20 896 /* offsetof(struct task_struct, thread.regs.gr[20]) */
#define TASK_PT_GR21 900 /* offsetof(struct task_struct, thread.regs.gr[21]) */
#define TASK_PT_GR22 904 /* offsetof(struct task_struct, thread.regs.gr[22]) */
#define TASK_PT_GR23 908 /* offsetof(struct task_struct, thread.regs.gr[23]) */
#define TASK_PT_GR24 912 /* offsetof(struct task_struct, thread.regs.gr[24]) */
#define TASK_PT_GR25 916 /* offsetof(struct task_struct, thread.regs.gr[25]) */
#define TASK_PT_GR26 920 /* offsetof(struct task_struct, thread.regs.gr[26]) */
#define TASK_PT_GR27 924 /* offsetof(struct task_struct, thread.regs.gr[27]) */
#define TASK_PT_GR28 928 /* offsetof(struct task_struct, thread.regs.gr[28]) */
#define TASK_PT_GR29 932 /* offsetof(struct task_struct, thread.regs.gr[29]) */
#define TASK_PT_GR30 936 /* offsetof(struct task_struct, thread.regs.gr[30]) */
#define TASK_PT_GR31 940 /* offsetof(struct task_struct, thread.regs.gr[31]) */
#define TASK_PT_FR0 944 /* offsetof(struct task_struct, thread.regs.fr[ 0]) */
#define TASK_PT_FR1 952 /* offsetof(struct task_struct, thread.regs.fr[ 1]) */
#define TASK_PT_FR2 960 /* offsetof(struct task_struct, thread.regs.fr[ 2]) */
#define TASK_PT_FR3 968 /* offsetof(struct task_struct, thread.regs.fr[ 3]) */
#define TASK_PT_FR4 976 /* offsetof(struct task_struct, thread.regs.fr[ 4]) */
#define TASK_PT_FR5 984 /* offsetof(struct task_struct, thread.regs.fr[ 5]) */
#define TASK_PT_FR6 992 /* offsetof(struct task_struct, thread.regs.fr[ 6]) */
#define TASK_PT_FR7 1000 /* offsetof(struct task_struct, thread.regs.fr[ 7]) */
#define TASK_PT_FR8 1008 /* offsetof(struct task_struct, thread.regs.fr[ 8]) */
#define TASK_PT_FR9 1016 /* offsetof(struct task_struct, thread.regs.fr[ 9]) */
#define TASK_PT_FR10 1024 /* offsetof(struct task_struct, thread.regs.fr[10]) */
#define TASK_PT_FR11 1032 /* offsetof(struct task_struct, thread.regs.fr[11]) */
#define TASK_PT_FR12 1040 /* offsetof(struct task_struct, thread.regs.fr[12]) */
#define TASK_PT_FR13 1048 /* offsetof(struct task_struct, thread.regs.fr[13]) */
#define TASK_PT_FR14 1056 /* offsetof(struct task_struct, thread.regs.fr[14]) */
#define TASK_PT_FR15 1064 /* offsetof(struct task_struct, thread.regs.fr[15]) */
#define TASK_PT_FR16 1072 /* offsetof(struct task_struct, thread.regs.fr[16]) */
#define TASK_PT_FR17 1080 /* offsetof(struct task_struct, thread.regs.fr[17]) */
#define TASK_PT_FR18 1088 /* offsetof(struct task_struct, thread.regs.fr[18]) */
#define TASK_PT_FR19 1096 /* offsetof(struct task_struct, thread.regs.fr[19]) */
#define TASK_PT_FR20 1104 /* offsetof(struct task_struct, thread.regs.fr[20]) */
#define TASK_PT_FR21 1112 /* offsetof(struct task_struct, thread.regs.fr[21]) */
#define TASK_PT_FR22 1120 /* offsetof(struct task_struct, thread.regs.fr[22]) */
#define TASK_PT_FR23 1128 /* offsetof(struct task_struct, thread.regs.fr[23]) */
#define TASK_PT_FR24 1136 /* offsetof(struct task_struct, thread.regs.fr[24]) */
#define TASK_PT_FR25 1144 /* offsetof(struct task_struct, thread.regs.fr[25]) */
#define TASK_PT_FR26 1152 /* offsetof(struct task_struct, thread.regs.fr[26]) */
#define TASK_PT_FR27 1160 /* offsetof(struct task_struct, thread.regs.fr[27]) */
#define TASK_PT_FR28 1168 /* offsetof(struct task_struct, thread.regs.fr[28]) */
#define TASK_PT_FR29 1176 /* offsetof(struct task_struct, thread.regs.fr[29]) */
#define TASK_PT_FR30 1184 /* offsetof(struct task_struct, thread.regs.fr[30]) */
#define TASK_PT_FR31 1192 /* offsetof(struct task_struct, thread.regs.fr[31]) */
#define TASK_PT_SR0 1200 /* offsetof(struct task_struct, thread.regs.sr[ 0]) */
#define TASK_PT_SR1 1204 /* offsetof(struct task_struct, thread.regs.sr[ 1]) */
#define TASK_PT_SR2 1208 /* offsetof(struct task_struct, thread.regs.sr[ 2]) */
#define TASK_PT_SR3 1212 /* offsetof(struct task_struct, thread.regs.sr[ 3]) */
#define TASK_PT_SR4 1216 /* offsetof(struct task_struct, thread.regs.sr[ 4]) */
#define TASK_PT_SR5 1220 /* offsetof(struct task_struct, thread.regs.sr[ 5]) */
#define TASK_PT_SR6 1224 /* offsetof(struct task_struct, thread.regs.sr[ 6]) */
#define TASK_PT_SR7 1228 /* offsetof(struct task_struct, thread.regs.sr[ 7]) */
#define TASK_PT_IASQ0 1232 /* offsetof(struct task_struct, thread.regs.iasq[0]) */
#define TASK_PT_IASQ1 1236 /* offsetof(struct task_struct, thread.regs.iasq[1]) */
#define TASK_PT_IAOQ0 1240 /* offsetof(struct task_struct, thread.regs.iaoq[0]) */
#define TASK_PT_IAOQ1 1244 /* offsetof(struct task_struct, thread.regs.iaoq[1]) */
#define TASK_PT_CR27 1248 /* offsetof(struct task_struct, thread.regs.cr27) */
#define TASK_PT_ORIG_R28 1256 /* offsetof(struct task_struct, thread.regs.orig_r28) */
#define TASK_PT_KSP 1260 /* offsetof(struct task_struct, thread.regs.ksp) */
#define TASK_PT_KPC 1264 /* offsetof(struct task_struct, thread.regs.kpc) */
#define TASK_PT_SAR 1268 /* offsetof(struct task_struct, thread.regs.sar) */
#define TASK_PT_IIR 1272 /* offsetof(struct task_struct, thread.regs.iir) */
#define TASK_PT_ISR 1276 /* offsetof(struct task_struct, thread.regs.isr) */
#define TASK_PT_IOR 1280 /* offsetof(struct task_struct, thread.regs.ior) */

#define TASK_SZ 1416 /* sizeof(struct task_struct) */
#define TASK_SZ_ALGN 1536 /* align(sizeof(struct task_struct), 64) */
...
#define TI_SEGMENT 16 /* offsetof(struct thread_info, addr_limit) */
#define TI_PRE_COUNT 40 /* offsetof(struct thread_info, preempt_count) */
